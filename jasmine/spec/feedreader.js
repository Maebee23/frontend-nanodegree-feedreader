...
$(function() {
  ...
  describe('Initial Entries', () => {
    ...
    it('has at least one entry', done => {
      expect($('.feed')).toContainElement($('.entry')); //checks if .feed contains .entry
      done();
    });
  });
  ...
  describe('New Feed Selection', () => {
    ...
    it('content actually changes', done => {
      loadFeed(2, () => console.log($('.feed').html())); //load feed 2 and check in console if feeds are different
